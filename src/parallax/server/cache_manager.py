...
class CacheManager:
    ...
    def _calculate_cache_allocation(
        ...
        # Use the same governed memory budget reported to the scheduler. Basing
        # cache allocation on MLX's full recommended working set would let the
        # executor reserve memory that Fabi deliberately kept for the desktop.
